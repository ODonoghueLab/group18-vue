<template>
  ...
  <v-flex xs12 sm9 >
    ...
    <v-card-text>
      <p>
        ...
        </a> there is a need to explore the possible interactions between the noble gases and proteins in order to provide
      ...
      <br/>
      <p>
        <img id="jolecule_image" src="/static/assets/group18_jolecule_help.png" alt="About Jolecule"/> 
      </p>
    </v-card-text>
    </v-card>        
  </v-flex>
  <v-flex xs12 sm3 >
    ...
    <p>
      ...
      <v-card id="contact" name="contact" class="panel body-side">
      <v-toolbar>
