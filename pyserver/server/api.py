...
from flask import abort, jsonify, current_app, request, helpers, json, make_response, send_from_directory, send_file
...
def report_exception_decorator(api_call):
    ...
    def _report_exception(*args, **kwargs):
        ...
        try:
            ...
            # limiting the exception information to 10000 characters
            # maximum (to prevent monstrous sqlalchemy outputs)
